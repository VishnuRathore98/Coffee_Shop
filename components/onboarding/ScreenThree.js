    ...
    return (
      <View style={styles.rootContainer}>
        ...
        <View style={styles.textContainer}>
          <Text style={{  fontSize:19, fontFamily:'Poppins_700Bold', color:GlobalStyles.colors.signUp.fillColor1, marginBottom:10 }}>
          Who doesn’t love rewards? We LOVE rewards!
          </Text>
          <Text style={{ fontSize:16, fontFamily:'Poppins_400Regular', color:GlobalStyles.colors.signUp.fillColor1 }}>
        ...
        <View style={{flexDirection:'row', justifyContent:'space-between', alignItems:'center', paddingHorizontal:20}}>
            <Image source={require('./beans3.png')} style={{height:40, width:104}}/>
        <Pressable onPress={()=>navigation.navigate('HomeScreen')} android_ripple={{color:'#F6F2ED'}} style={styles.button}><Text style={{color:'#F6F2ED', fontSize:14, fontFamily:'Poppins_400Regular'}}>NEXT</Text></Pressable>
        </View>
      </View>
    );
  }
