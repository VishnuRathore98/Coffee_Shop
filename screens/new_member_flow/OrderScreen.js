...
<View style={styles.drinksContainer}>
    ...
    <View>
        ...
        <TouchableOpacity onPress={()=>navigation.navigate('ProductDetailScreen',{img:GlobalImages.hotCoffees,name:'Hot Coffees'})} style={{ elevation:2, justifyContent:'center', alignItems:'center', backgroundColor:'white', borderRadius:10, margin:5, maxWidth:108}}><Image style={{ width:110, height:120}} source={{uri:GlobalImages.hotCoffees}}/><Text style={{fontSize:14,  fontFamily:"Poppins_500Medium"}}>Hot Coffees</Text></TouchableOpacity>
            ...
            <TouchableOpacity onPress={()=>navigation.navigate('ProductDetailScreen',{img:GlobalImages.frappucino,name:'Frappucino'})} style={{ elevation:2, justifyContent:'center', alignItems:'center', backgroundColor:'white', borderRadius:10, margin:5, maxWidth:108}}><Image style={{width:110, height:120}} source={{uri:GlobalImages.frappucino}}/><Text style={{fontSize:14,  fontFamily:"Poppins_500Medium"}}>Frappucino</Text></TouchableOpacity>
            <TouchableOpacity onPress={()=>navigation.navigate('ProductDetailScreen',{img:GlobalImages.coldCoffees,name:'Cold Coffees'})} style={{ elevation:2, justifyContent:'center', alignItems:'center', backgroundColor:'white', borderRadius:10, margin:5, maxWidth:108}}><Image style={{width:110, height:120}} source={{uri:GlobalImages.coldCoffees}}/><Text style={{fontSize:14,  fontFamily:"Poppins_500Medium"}}>Cold Coffees</Text></TouchableOpacity>
            <TouchableOpacity onPress={()=>navigation.navigate('ProductDetailScreen',{img:GlobalImages.icedTeas,name:'Iced Teas'})} style={{ elevation:2, justifyContent:'center', alignItems:'center', backgroundColor:'white', borderRadius:10, margin:5, maxWidth:108}}><Image style={{width:110, height:120}} source={{uri:GlobalImages.icedTeas}}/><Text style={{fontSize:14,  fontFamily:"Poppins_500Medium"}}>Iced Teas</Text></TouchableOpacity>
            <TouchableOpacity onPress={()=>navigation.navigate('ProductDetailScreen',{img:GlobalImages.coldDrinks,name:'Cold Drinks'})} style={{ elevation:2, justifyContent:'center', alignItems:'center', backgroundColor:'white', borderRadius:10, margin:5, maxWidth:108}}><Image style={{width:110, height:120}} source={{uri:GlobalImages.coldDrinks}}/><Text style={{fontSize:14,  fontFamily:"Poppins_500Medium"}}>Cold Drinks</Text></TouchableOpacity>
        </View>
    </View>
</View>
...
<View style={styles.drinksContainer}>
                ...
                <View>
                    <View style={{flexDirection:'row',  alignItems:'center', flexWrap:'wrap'}}>
                        ...
                        <TouchableOpacity onPress={()=>navigation.navigate('ProductDetailScreen',{img:GlobalImages.other,name:'Other'})} style={{ elevation:2, justifyContent:'center', alignItems:'center', backgroundColor:'white', borderRadius:10, margin:5, maxWidth:108}}><Image style={{width:110, height:120}} source={{uri:GlobalImages.other}}/><Text style={{fontSize:14,  fontFamily:"Poppins_500Medium"}}>Other</Text></TouchableOpacity>
                    </View>
                </View>
            </View>
